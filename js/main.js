    ...
    switch (currentScene) {
      case 0:
        ...
        if (scrollRatio <= 0.22) {
          ...
          objs.messageA.style.transform = `translateY(${calcValues(values.messagaA_translateY_in, currrentYOffset)}%)`;
        } else {
          //out
          objs.messageA.style.opacity = calcValues(values.messageA_opacity_out, currrentYOffset)
          objs.messageA.style.transform = `translateY(${calcValues(values.messagaA_translateY_out, currrentYOffset)}%)`;
        }
        if (scrollRatio <= 0.42) {
          // in
